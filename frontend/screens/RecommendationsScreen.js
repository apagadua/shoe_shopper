...
// Shoes tagged with function path, silhouette path, and attributes.
// At least one shoe per (path, category, subcategory) combo and each attribute covered.
const ALL_SHOES = [
  {
    id: '1',
  ...
  },
  {
    ...
    name: 'TrailLine Pro',
    brand: 'Summit & Co.',
    description: 'Grippy outsole, locked-in heel, cushioned arch.',
    functionPath: ['Athletic', 'Hiking'],
    silhouettePath: ['Sneaker', 'High-top'],
    attributes: { waterproof: true, slipResistant: true },
    availableSizes: ['9', '9.5', '10', '11'],
    typicalSize: '9.5',
    lengthCm: '27.0',
    widthCm: '10.0',
  },
  {
    ...
    name: 'Bull Run Moc',
    brand: 'Danner',
    description: 'Classic moc toe, durable for work or weekend.',
    functionPath: ['Work', 'Outdoor', 'Casual', 'Boots'],
    silhouettePath: ['Boot', 'Moc Toe'],
    attributes: { leather: true, resoleable: true, slipResistant: true },
    availableSizes: ['8', '8.5', '9', '10'],
    typicalSize: '9',
    lengthCm: '26.5',
    widthCm: '9.9',
  },
  {
    ...
    name: 'Weekend Loafer',
    brand: 'Solace',
    description: 'Slip-on comfort, clean look.',
    functionPath: ['Casual', 'Slip-ons'],
    silhouettePath: ['Slip-on', 'Loafer'],
    attributes: { vegan: true },
    availableSizes: ['7.5', '8', '8.5', '9'],
    typicalSize: '8.5',
    lengthCm: '25.8',
    widthCm: '9.4',
  },
  {
    ...
    name: 'Office Oxford',
    brand: 'Formal Step',
    description: 'Dress shoe for formal occasions.',
    functionPath: ['Formal'],
    silhouettePath: ['Dress Shoe'],
    attributes: { leather: true },
    availableSizes: ['8', '9', '10', '11'],
    typicalSize: '9',
    lengthCm: '26.8',
    widthCm: '9.6',
  },
  // Athletic + remaining subcategories
  {
    id: '7',
    name: 'PowerLift Trainer',
    brand: 'StrideLab',
    description: 'Stable platform for lifting and cross-training.',
    functionPath: ['Athletic', 'Training'],
    silhouettePath: ['Sneaker', 'Low-top'],
    attributes: {},
    availableSizes: ['8.5', '9', '9.5', '10'],
    typicalSize: '9',
    lengthCm: '26.0',
    widthCm: '9.7',
  },
  {
    ...
    name: 'Court King',
    brand: 'Jump Co.',
    description: 'Ankle support and cushioning for the court.',
    functionPath: ['Athletic', 'Basketball'],
    silhouettePath: ['Sneaker', 'High-top'],
    attributes: {},
  ...
  },
  {
    ...
    name: 'Pitch Pro',
    brand: 'KickForm',
    description: 'Lightweight, stud-ready for turf or grass.',
    functionPath: ['Athletic', 'Soccer'],
    silhouettePath: ['Sneaker', 'Low-top'],
    attributes: {},
    availableSizes: ['7', '8', '8.5', '9'],
    typicalSize: '8',
    lengthCm: '25.4',
    widthCm: '9.3',
  },
  {
    ...
    name: 'Ace Court',
    brand: 'Serve & Run',
    description: 'Lateral support and durable outsole for hard courts.',
    functionPath: ['Athletic', 'Tennis'],
    silhouettePath: ['Sneaker', 'Low-top'],
    attributes: {},
    availableSizes: ['8', '8.5', '9', '9.5'],
    typicalSize: '8.5',
  ...
  },
  {
    ...
    name: 'Deck Rider',
    brand: 'Street Grip',
    description: 'Flat sole and board feel for skating.',
    functionPath: ['Athletic', 'Skate'],
    silhouettePath: ['Sneaker', 'Low-top'],
    attributes: {},
    availableSizes: ['8', '9', '9.5', '10'],
    typicalSize: '9',
    lengthCm: '26.3',
    widthCm: '9.6',
  },
  // Work + Indoor
  {
    ...
    name: 'Kitchen Clog',
    brand: 'SafeStep',
    description: 'Slip-resistant, easy to clean for food service.',
    functionPath: ['Work', 'Indoor'],
    silhouettePath: ['Slip-on', 'Clog'],
    attributes: { slipResistant: true },
    availableSizes: ['6', '7', '8', '9'],
    typicalSize: '8',
    lengthCm: '25.6',
    widthCm: '9.8',
  },
  // Boot silhouettes: Chelsea, Chukka, Hiking, Work, Combat, Dress
  {
    id: '13',
    name: 'City Chelsea',
    brand: 'Urban Form',
    description: 'Pull-on ankle boot, sleek for everyday wear.',
    functionPath: ['Casual', 'Boots'],
    silhouettePath: ['Boot', 'Chelsea'],
    attributes: { leather: true },
    availableSizes: ['8', '8.5', '9', '9.5'],
    typicalSize: '9',
    lengthCm: '26.4',
  ...
  },
  {
    ...
    name: 'Desert Chukka',
    brand: 'Solace',
    description: 'Ankle-high, two or three eyelets, casual style.',
    functionPath: ['Casual', 'Boots'],
    silhouettePath: ['Boot', 'Chukka'],
    attributes: { leather: true },
    availableSizes: ['8.5', '9', '10', '11'],
    typicalSize: '9.5',
    lengthCm: '26.9',
    widthCm: '9.7',
  },
  {
    ...
    name: 'Ridge Hiker',
    brand: 'Summit & Co.',
    description: 'Waterproof, ankle support for trails.',
    functionPath: ['Athletic', 'Hiking'],
    silhouettePath: ['Boot', 'Hiking'],
    attributes: { waterproof: true, insulated: true },
    availableSizes: ['9', '9.5', '10', '11'],
    typicalSize: '9.5',
    lengthCm: '27.1',
    widthCm: '10.1',
  },
  {
    ...
    name: 'Steel Toe Work',
    brand: 'Danner',
    description: 'Safety toe, oil-resistant sole for job sites.',
    functionPath: ['Work', 'Outdoor'],
    silhouettePath: ['Boot', 'Work'],
    attributes: { slipResistant: true, resoleable: true },
  ...
  },
  {
    ...
    name: 'Tactical 6"',
    brand: 'Rugged',
    description: 'Durable upper, aggressive tread for tough conditions.',
    functionPath: ['Casual', 'Boots'],
    silhouettePath: ['Boot', 'Combat'],
  ...
  {
    id: '18',
    name: 'Cap Toe Dress Boot',
    brand: 'Formal Step',
    description: 'Polished leather for business or evening.',
    functionPath: ['Formal'],
    silhouettePath: ['Boot', 'Dress'],
    attributes: { leather: true, resoleable: true },
    availableSizes: ['8', '9', '10'],
    typicalSize: '9',
    lengthCm: '26.7',
    widthCm: '9.6',
  },
  // Sneaker + Slip-on Sneaker
  {
    id: '19',
    name: 'Easy Slip Sneaker',
    brand: 'Urban Form',
    description: 'No laces, slip in and go.',
    functionPath: ['Casual', 'Slip-ons'],
    silhouettePath: ['Sneaker', 'Slip-on Sneaker'],
    attributes: { vegan: true },
    availableSizes: ['7.5', '8', '8.5', '9'],
    typicalSize: '8.5',
    lengthCm: '25.7',
  ...
  // Slip-on + Clog (already have id 12)
  // Resoleable and insulated: add one more insulated
  {
    id: '20',
    name: 'Winter Pac',
    brand: 'Summit & Co.',
    description: 'Insulated for cold weather and snow.',
    functionPath: ['Athletic', 'Hiking'],
    silhouettePath: ['Boot', 'Hiking'],
    attributes: { waterproof: true, insulated: true },
    availableSizes: ['8', '8.5', '9', '10'],
  ...
  // Extra coverage so multi-attribute filters have options
  {
    id: '21',
    name: 'Vegan Runner',
    brand: 'StrideLab',
    description: 'All synthetic, no animal products.',
    functionPath: ['Athletic', 'Running'],
    silhouettePath: ['Sneaker', 'Low-top'],
    attributes: { vegan: true },
    availableSizes: ['8', '8.5', '9', '9.5'],
  ...
  {
    id: '22',
    name: 'All-Weather Moc',
    brand: 'Danner',
    description: 'Waterproof leather moc for wet days.',
    functionPath: ['Casual', 'Boots'],
    silhouettePath: ['Boot', 'Moc Toe'],
    attributes: { leather: true, waterproof: true, resoleable: true },
    availableSizes: ['8.5', '9', '9.5', '10'],
    typicalSize: '9',
    lengthCm: '26.5',
    widthCm: '9.9',
  },
  {
    ...
    name: 'Grip Kitchen',
    brand: 'SafeStep',
    description: 'Non-slip kitchen and service footwear.',
    functionPath: ['Work', 'Indoor'],
    silhouettePath: ['Slip-on', 'Clog'],
    attributes: { slipResistant: true, vegan: true },
    availableSizes: ['6', '7', '8', '9'],
    typicalSize: '8',
    lengthCm: '25.5',
    widthCm: '9.7',
  },
  {
    ...
    name: 'Classic Derby',
    brand: 'Formal Step',
    description: 'Open lacing, versatile dress shoe.',
    functionPath: ['Formal'],
    silhouettePath: ['Dress Shoe'],
    attributes: { leather: true, resoleable: true },
    availableSizes: ['8', '9', '9.5', '10'],
