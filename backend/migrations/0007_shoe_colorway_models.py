...
class Migration(migrations.Migration):
    ...
    ShoeColorway: one row per GOAT product (colorway). Linked to Shoe (model-level).
    ShoeColorwaySize: one row per size within a colorway, with per-size GOAT pricing.
    """

    dependencies = [
        ("backend", "0006_shoe_is_active"),
    ]
